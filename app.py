...
# 1. 页面配置
# ============================================================
st.set_page_config(page_title="⚽ 六爻预测 V9.3.7（日期版）", layout="centered", initial_sidebar_state="collapsed")
st.title("⚽ 六爻 · 纯卦象预测引擎 V9.3.7")
st.caption("V9.3.7 最终优化：赛季末无欲强队、澳超/芬超大球、亚冠客场、美职方差等全面修正 | 起卦只依赖日期")
